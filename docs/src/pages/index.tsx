      ...
      <main>
        <section className={clsx(styles.section, styles.heroBanner)}>
          <div className={styles.heroContent}>
            ...
            <p className={styles.heroSubtitle}>
              Craft documentation that feels premium out-of-the-box. The Hoverkraft
              theme blends an opinionated visual system with pragmatic components
              that stay out of your way and let your content shine.
            </p>
        ...
        <section className={styles.section}>
          <div className="container">
            ...
            <p className={styles.sectionSubtitle}>
              We distilled years of product storytelling into a reusable design system that
              works for launches, integrations, and long-form documentation.
            </p>
        ...
        <section className={styles.section}>
          <div className="container">
            ...
            <p className={styles.sectionSubtitle}>
              Update three CSS variables and the entire site adapts—from hero gradients to
              code blocks and footers—while respecting accessibility contrast ratios.
            </p>
        ...
        <section className={styles.section}>
          <div className="container">
            ...
            <p className={styles.sectionSubtitle}>
              Every detail—from TypeScript support to content structure—was designed to
              keep teams shipping purposeful, consistent documentation.
            </p>
            ...
            <div className={styles.callout}>
              ...
              <p>
                Follow the installation guide, wire up the theme config, and customize the
                layout in minutes. We included live examples, copy-ready snippets, and a
